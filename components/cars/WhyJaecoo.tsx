...
export default function WhyJaecoo() {
  return (
    <section className="py-32 px-6 md:px-16 bg-black relative overflow-hidden border-t border-neutral-900/40">
      {/* Aksesori Cahaya Latar Belakang yang Sangat Halus */}
      <div className="absolute bottom-0 right-0 w-75 h-75 bg-emerald-500/1 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-36">
            ...
            <p className="text-neutral-500 text-xs md:text-sm font-light leading-relaxed mt-6 pr-4">
          ...
          <div className="lg:col-span-8 border-t border-neutral-900">
            {items.map((item, index) => (
              <div
                key={item.title}
                className="py-10 border-b border-neutral-900 flex flex-col md:flex-row md:items-start justify-between gap-6 group hover:bg-neutral-900/10 transition-colors duration-500 px-4 -mx-4"
              >
                {/* Penomoran & Tag */}
                <div className="flex items-center gap-4 md:w-1/4">
                  ...
                  <span className="text-[9px] font-bold tracking-widest text-neutral-500 uppercase bg-neutral-900 px-2.5 py-1 border border-neutral-800">
                    {item.tag}
                  </span>
                </div>
                ...
                <div className="md:w-3/4">
                  <h3 className="text-lg md:text-xl font-black uppercase tracking-wider text-white group-hover:text-emerald-400 transition-colors duration-300">
                    {item.title}
                  </h3>
                  <p className="text-neutral-400 text-xs md:text-sm font-light leading-relaxed mt-3 pr-6">
                    {item.desc}
                  </p>
                </div>
              </div>
